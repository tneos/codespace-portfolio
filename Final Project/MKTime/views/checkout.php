                  ...
                  <div class="col-lg-6 px-5 py-4 checkout-scroll">
                   ...
                   <?php } ?>
                    ...
                    <div class="d-flex justify-content-between p-2 mb-2">
                      ...
                      <h5 class="mb-0 montserrat-300">£<?php echo number_format((float)array_sum(array_map("calculateItemTotal", $items_total_price, $items_quantity )), 2, '.', ''); ?></h5>
                    </div>
                  </div>
                    ...
                    <form class="mb-5" method="POST" action="../actions/place_order.php">
                      ...
                      <div class="form-outline mb-5">
                        ...
                        <input
                          ...
                          value="John Doe"
                        />
                        <label class="form-label montserrat-300" for="typeName"
                          >Name on card</label
                        >
                      </div>
                        ...
                        <div class="col-md-6 mb-5">
                          <div data-mdb-input-init class="form-outline">
                            <input
                              ...
                              maxlength="5"
                            />
                            <label class="form-label montserrat-300" for="typeExp"
                              >Expiration</label
                            >
                          </div>
                        </div>
                      ...
                      <div class="form-group my-5">
                        <a
                          href="index.php"
                          class="link-underline-dark montserrat-300 text-dark mx-2"
                          >Back to shopping</a
                        >
                      </div>
                    </form>
